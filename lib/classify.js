...
const RULES = [
  ...
  {
    section: 'policy',
    re: /\b(regulat\w+|congress|senate|house (bill|committee)|lawmakers?|white house|executive order|eu ai act|ai act|legislation|bill|lawsuit|sues?|court|judge|ftc|sec|doj|antitrust|copyright|ban(s|ned)?|government|federal|state law|policy|election|trump|biden|harris|governor|brussels|parliament|tariffs?|export controls?)\b/i,
  },
  {
    section: 'markets',
